...
function timeoutForAttempt(base, attempt) {
    ...
    var NEXUS_STORAGE_SCHEMA = '1.25.8';
                        ...
                        Object.keys(res.seasons).forEach(function(sNum) {
                            ...
                            if (sObj && sObj.episodes) {
                                Object.keys(sObj.episodes).forEach(function(eNum) {
                                    var iframeLink = sObj.episodes[eNum];
                                    var directIframe = iframeLink.indexOf("//") === 0 ? ("https:" + iframeLink) : iframeLink;
                                    results.push({
                                        title: "Сезон " + sNum + ", Серия " + eNum,
                                        season: parseInt(sNum, 10),
                                        episode: parseInt(eNum, 10),
                                        url: directIframe,
                                        quality: { "HD 720p": directIframe }
                                    });
                                });
                            }
                        });
